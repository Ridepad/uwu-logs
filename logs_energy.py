...
POWER_TYPES = {
    ...
    '7': 'shards',
    # Soul Shards are collected by Warlocks, and range from 0 to 5 (was 0 to 3) indicating how many are available. Soul Shards degenerate out of combat (used to not in World of Warcraft: Warlords of Draenor Warlords of Draenor).
}
